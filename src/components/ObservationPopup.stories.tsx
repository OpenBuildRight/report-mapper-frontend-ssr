...
const mockObservation: Observation = {
  id: '1',
  description: 'Beautiful sunset observation with multiple photos taken from different angles. The colors were absolutely stunning and the weather was perfect.',
  location: {
    latitude: 43.0731,
    longitude: -89.4012,
  },
