      ...
      for (const photo of formData.photos) {
        ...
        if (photo.location) {
          ...
          photoFormData.append(
            "longitude",
            photo.location.longitude.toString(),
          );
        }
    ...
    <div className="bg-gray-800 rounded-lg shadow-md p-8 border border-gray-700">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          <div
            className={`text-sm font-medium ${currentStep === "photos" ? "text-blue-400" : "text-gray-400"}`}
          >
            1. Photos
          </div>
          <div
            className={`text-sm font-medium ${currentStep === "location" ? "text-blue-400" : "text-gray-400"}`}
          >
            2. Location
          </div>
          <div
            className={`text-sm font-medium ${currentStep === "description" ? "text-blue-400" : "text-gray-400"}`}
          >
            3. Description
          </div>
          <div
            className={`text-sm font-medium ${currentStep === "review" ? "text-blue-400" : "text-gray-400"}`}
          >
            4. Review
          </div>
        </div>
