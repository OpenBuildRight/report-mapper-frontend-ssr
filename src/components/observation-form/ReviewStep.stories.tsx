...
const mockFormData: ObservationFormData = {
  description:
    "Observed a large flock of migratory birds heading south. The weather was clear with light winds from the northwest. Birds were flying in a V-formation at approximately 500 feet altitude. Estimated count: 150-200 birds.",
  location: {
    latitude: 37.7749,
    longitude: -122.4194,
  },
